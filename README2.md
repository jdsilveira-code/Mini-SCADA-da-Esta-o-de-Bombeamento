## Tabela de Taxa de Dose de Radiação
...
## Tabela de Dose Acumulada de Radiação
...
| 10000 mSv | Geralmente fatal em semanas |
| >20000 mSv | Fatal em poucos dias |

## Tabela de Temperatura do Núcleo do Reator

| Temperatura (K) | Condição Operacional |
|-----------------|----------------------|
| **< 600 K** | **Operação fria ou baixa potência** |
| 600 - 900 K | Operação normal em diversos sistemas nucleares |
| 900 - 1200 K | Operação em alta potência, porém dentro da faixa de projeto |
| 1200 - 1500 K | Região de atenção; monitoramento intensivo necessário |
| **1500 - 2000 K** |**Região crítica; risco de danos ao combustível e materiais estruturais** |
| 2000 - 2500 K | Possível degradação severa do revestimento do combustível |
| 2500 - 3000 K | Alto risco de fusão parcial do núcleo |
| > 3000 K | Região de acidente grave; provável fusão do núcleo (meltdown) |
