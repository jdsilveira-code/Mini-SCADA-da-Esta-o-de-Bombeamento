...
// NOVAS CLASSES: Estratégias de alto nível (Strategy pattern)
// Estratégia que aplica comandos diretos do supervisório/usuário.
class EstrategiaManual : public EstrategiaControle {
private:
    AcaoBomba AcaoBombaAtual;
    float PotenciaBomba;
    AcaoVaretas AcaoVaretas; // AUTOMATICO, INSERIR, RETIRAR
...
// Estratégia automática que encapsula os controles automáticos já existentes.
